document.addEventListener("DOMContentLoaded", () => {
    ...
    questionInput.value = "Чи буде завтра холодно надворі?";
    ...
    function adaptability() {
        ...
        if (mainContentWidth <= 1000) {
            questionInput.style.fontSize = "35px";
        ...
        if (mainContentWidth <= 200) {
            questionInput.style.fontSize = "10px";
